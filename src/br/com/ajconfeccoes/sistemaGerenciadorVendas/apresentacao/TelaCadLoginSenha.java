 ...
 * @author arley
 */
public class TelaCadLoginSenha extends Tela {
   
    private Tela telaAnterior;
    private Usuario usuario;
    
    public TelaCadLoginSenha() {
        initComponents();
    }
    
    public TelaCadLoginSenha(Tela telaAnterior){
        initComponents();
        this.telaAnterior = telaAnterior;
    }
    
    public TelaCadLoginSenha(Tela telaAnterior, Usuario usuario){
        initComponents();
        this.telaAnterior = telaAnterior;
    ...
    private void initComponents() {
        ...
        btnVoltar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/ajconfeccoes/sistemaGerenciadorVendas/apresentacao/imagens/arrow_left.png"))); // NOI18N
       ...
       if(mensagem == "" || mensagem == null){
           if(senha.equals(senha2)){
               try {
                   ...
                   Logger.getLogger(TelaCadLoginSenha.class.getName()).log(Level.SEVERE, null, ex);
